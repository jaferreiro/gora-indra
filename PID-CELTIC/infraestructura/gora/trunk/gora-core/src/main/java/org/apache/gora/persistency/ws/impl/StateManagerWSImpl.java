...
public class StateManagerWSImpl implements StateManager {
  ...
  public Object clone() {
    try {
      StateManagerWSImpl newInstance = (StateManagerWSImpl) super.clone();
      newInstance.dirtyBits = (BitSet) this.dirtyBits.clone() ;
      newInstance.readableBits = (BitSet) this.readableBits.clone() ;
      return newInstance ;
