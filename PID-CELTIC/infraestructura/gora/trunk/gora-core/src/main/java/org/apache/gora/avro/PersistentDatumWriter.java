...
public class PersistentDatumWriter<T extends PersistentBase>
  ...
  protected void writeBytes(Object datum, Encoder out) throws IOException {
    int initialPosition = ((ByteBuffer)datum).position() ;
    super.writeBytes(datum, out);                   // GenericDatumWriter will change ByteBuffer position to last!
    ((ByteBuffer)datum).position(initialPosition) ; // Rewind (but could be in middle -Cassandra case-)
  }
