      ...
      case RECORD:
        ...
        for (Field field : schema.getFields()) {
          ...
          case FIXED:
            ...
            line(2, "put("+i+", value);");
            line(1, "}");
            // String wrapper for Utf8
            if (fieldSchema.getType() == Schema.Type.STRING) {
              line(1, "public void set"+camelKey+"(String value) {");
              line(2, "Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; ") ;
              line(2, "set"+camelKey+"(valueUtf8);");
              line(1, "}");
            }
            // (end) String wrapper
            break;
          case ARRAY:
            ...
            if (fieldSchema.getElementType().getType() == Schema.Type.STRING) {
              line(1, "public void addTo"+camelKey+"(String element) {");
              line(2, "Utf8 elementUtf8 = (element==null)? null : new Utf8(element) ; ") ;
              line(2, "addTo"+camelKey+"(elementUtf8);");
              line(1, "}");
            }
            // (end) String wrapper
            break;
          case MAP:
            ...
            // String wrappers for Utf8
            line(1, "public "+fieldType+" getFrom"+camelKey+"(String key) {");
            line(2, "Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; ") ;
            line(2, "return getFrom"+camelKey+"(keyUtf8);");
            line(1, "}");
            
            line(1, "public void putTo"+camelKey+"(String key, "+unboxed+" value) {");
            line(2, "Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; ") ;
            line(2, "putTo"+camelKey+"(keyUtf8, value);");
            line(1, "}");

            if (fieldSchema.getValueType().getType() == Schema.Type.STRING) {
              line(1, "public void putTo"+camelKey+"(Utf8 key, String value) {");
              line(2, "Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; ") ;
              line(2, "putTo"+camelKey+"(key, valueUtf8);");
              line(1, "}");

              line(1, "public void putTo"+camelKey+"(String key, String value) {");
              line(2, "Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; ") ;
              line(2, "Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; ") ;
              line(2, "putTo"+camelKey+"(keyUtf8, valueUtf8);");
              line(1, "}");
            }

            line(1, "public "+fieldType+" removeFrom"+camelKey+"(String key) {");
            line(2, "Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; ") ;
            line(2, "return removeFrom"+camelKey+"(keyUtf8);");
            line(1, "}");
            // (end) String wrappers
