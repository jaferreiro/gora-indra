...
public class MapReduceSerialization extends Configured implements Tool {
  ...
  private static final Log LOG = LogFactory.getLog(MapReduceSerialization.class) ;
  ...
  /**
   * {@link CheckDirtyBitsSerializationReducer} just take vales and emits
   * them as is.
   */
  public static class CheckDirtyBitsSerializationReducer extends GoraReducer<Text, WebPage, 
  String, WebPage> {
  ...
  public Job createJob(DataStore<String,WebPage> inStore, Query<String,WebPage> query
     ...
     * can be used instead.
     */
    GoraReducer.initReducerJob(job, outStore, CheckDirtyBitsSerializationReducer.class);
