...
public class WebPage extends PersistentBase {
  ...
  public void addToParsedContent(String element) {
    Utf8 elementUtf8 = (element==null)? null : new Utf8(element) ; 
    addToParsedContent(elementUtf8);
  }
  ...
  public Utf8 getFromOutlinks(String key) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    return getFromOutlinks(keyUtf8);
  }
  public void putToOutlinks(String key, Utf8 value) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    putToOutlinks(keyUtf8, value);
  }
  public void putToOutlinks(Utf8 key, String value) {
    Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; 
    putToOutlinks(key, valueUtf8);
  }
  public void putToOutlinks(String key, String value) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; 
    putToOutlinks(keyUtf8, valueUtf8);
  }
  public Utf8 removeFromOutlinks(String key) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    return removeFromOutlinks(keyUtf8);
  }
