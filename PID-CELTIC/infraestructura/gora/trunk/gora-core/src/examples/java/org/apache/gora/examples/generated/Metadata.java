...
public class Metadata extends PersistentBase {
  ...
  public Utf8 getFromData(String key) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    return getFromData(keyUtf8);
  }
  public void putToData(String key, Utf8 value) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    putToData(keyUtf8, value);
  }
  public void putToData(Utf8 key, String value) {
    Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; 
    putToData(key, valueUtf8);
  }
  public void putToData(String key, String value) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    Utf8 valueUtf8 = (value==null)? null : new Utf8(value) ; 
    putToData(keyUtf8, valueUtf8);
  }
  public Utf8 removeFromData(String key) {
    Utf8 keyUtf8 = (key==null)? null : new Utf8(key) ; 
    return removeFromData(keyUtf8);
  }
}
