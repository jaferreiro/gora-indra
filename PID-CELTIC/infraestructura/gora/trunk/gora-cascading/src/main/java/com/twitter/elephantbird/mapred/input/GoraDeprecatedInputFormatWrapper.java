...
public class GoraDeprecatedInputFormatWrapper<K,V> extends DeprecatedInputFormatWrapper<K,V> {
  ...
  public static void setInputFormat(Class<?> realInputFormatClass, JobConf jobConf) {
    jobConf.setInputFormat(GoraDeprecatedInputFormatWrapper.class);
  ...
  public GoraDeprecatedInputFormatWrapper() {
    // real inputFormat is initialized based on conf.
  }

  public GoraDeprecatedInputFormatWrapper(InputFormat<K, V> realInputFormat) {
      ...
      try {
        if (realReader.nextKeyValue()) {
            ...
            if (mifcReader != null) {
              ...
              throw new IOException("GoraDeprecatedInputFormatWrapper only "
                  ...
                  + "Current reader class : " + realReader.getClass());
                    ...
                    if (value != realReader.getCurrentValue()) {
                        if (null != valueCopier)
                            ...
                            throw new IOException("GoraDeprecatedInputFormatWrapper - value is different "
