...
public class TestRow extends PersistentBase {
  public static final Schema _SCHEMA = Schema.parse("{\"type\":\"record\",\"name\":\"TestRow\",\"namespace\":\"org.apache.gora.cascading.test.storage\",\"fields\":[{\"name\":\"defaultLong1\",\"type\":\"long\",\"default\":1},{\"name\":\"defaultStringEmpty\",\"type\":\"string\"},{\"name\":\"columnLong\",\"type\":[\"null\",\"long\"]},{\"name\":\"unionRecursive\",\"type\":[\"null\",\"TestRow\"]},{\"name\":\"unionString\",\"type\":[\"null\",\"string\"]},{\"name\":\"unionLong\",\"type\":[\"null\",\"long\"]},{\"name\":\"unionDefNull\",\"type\":[\"null\",\"long\"]},{\"name\":\"family2\",\"type\":{\"type\":\"map\",\"values\":\"string\"}}]}");
  ...
  static {
    PersistentBase.registerFields(TestRow.class, _ALL_FIELDS);
  }
  private long defaultLong1;
  private Utf8 defaultStringEmpty;
  private Long columnLong;
  private TestRow unionRecursive;
  ...
  public TestRow(StateManager stateManager) {
    super(stateManager);
    family2 = new StatefulHashMap<Utf8,Utf8>();
  }
  public TestRow newInstance(StateManager stateManager) {
    return new TestRow(stateManager);
  }
  ...
  public void put(int _field, Object _value) {
    ...
    case 3:unionRecursive = (TestRow)_value; break;
  ...
  public TestRow getUnionRecursive() {
    return (TestRow) get(3);
  }
  public void setUnionRecursive(TestRow value) {
    put(3, value);
  }
